...
Tworzenie podrozdziałów polega na stworzeniu nowej lini rozpoczynającej się od znaków `##` a następnie tytułu podrozdziału.
Dodatkowo w postaci `{#}` można dodać skrót nazwy rozdziału/podrozdziału umożliwiający odnoszenie się do niego używając operatora `\@ref()`.
