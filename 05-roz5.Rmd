...
```{r rycina4, echo=FALSE, fig.cap="Procentowy udział form pokrycia terenu dla lat 1990 i 2018", out.width=350}
...
Spowodowane jest to mniejszym udziałem ekstremalnych zmian pokrycia terenu w całkowitej powierzchni powiatów.
