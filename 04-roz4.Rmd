...
**wkleić raster contingency table "Tabela 3. Kierunki zmian użytkowania ziemi w Polsce w latach 1930–2000"**
<!--
...
-->
<!--
```{r rycina43, echo=FALSE, fig.cap="Kategorie pokrycia terenu wyróżnione w bazie danych CORINE Land Cover."}
knitr::include_graphics("figures/CLC_legend_PL.pdf")
```
-->
