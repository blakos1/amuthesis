...
W wyniku otrzymywana jest macierz o wymiarach k na k, gdzie k jest równe liczbie klas występujących w rastrze kategoryzowanym.
...
```{r,warning=FALSE, message=FALSE, out.lines=4}
library(motif)
library(stars)
...
## Przygotowanie danych do analizy struktury przestrzennej {#analiza}
...
**POWIĘKSZYĆ RYCINĘ, ZMIENIĆ PODPIS**
...
**Celem trzeciego etapu było pozyskanie obliczonych różnic w stanie struktur przestrzennych jednostek przestrzennych. <-przepisać**
W celu trafnego stwierdzenia prawidłowości dotyczących zmian struktury przestrzennej, dane zostały przeanalizowane na dwóch poziomach:
...
Do ilościowej oceny wielkości zmian każdej jednostki wykorzystuje się miary niepodobieństwa.
